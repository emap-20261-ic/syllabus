...
\begin{frame}[fragile,allowframebreaks]{condicionais e expressões lógicas}
  ...
  \lstinputlisting[style=tinyc,caption=raiz.c]{raiz.c}

  \framebreak

  \lstinputlisting[style=tinyc,caption=parity0.c]{parity0.c}
  ...
  \lstinputlisting[style=tinyc,caption=agree.c]{agree.c}
  ...
  \lstinputlisting[style=tinyc,caption=area.c]{area.c}
...
\begin{frame}[allowframebreaks,fragile]{Repetição, repetição \ldots}
  ...
  \lstinputlisting[style=tinyc,caption=meow0.c]{meow0.c}

  \framebreak

  \lstinputlisting[style=tinyc,caption=meow1.c]{meow1.c}
    
  \lstinputlisting[style=tinyc,caption=meow2.c]{meow2.c}
  ...
  \lstinputlisting[style=tinyc,caption=guess.c]{guess.c}
