...
\begin{frame}[fragile,allowframebreaks]{debugging}
  ...
  \lstinputlisting[style=tinyc,caption=memory.c]{memory.c}
...
\begin{frame}[allowframebreaks,fragile]{lixo na memória}
  ...
  \lstinputlisting[style=tinyc,caption=garbage0.c]{garbage0.c}
  ...
  \lstinputlisting[style=tinyc,caption=garbage1.c]{garbage1.c}
