...
\begin{frame}[allowframebreaks,fragile]{scanf}
  ...
  \lstinputlisting[style=tinyc,caption=scanf1.c]{scanf1.c}
  ...
  \lstinputlisting[style=tinyc,caption=scanf2.c]{scanf2.c}
  ...
  \lstinputlisting[style=tinyc,caption=scanf3.c]{scanf3.c}
...
\begin{frame}[allowframebreaks,fragile]{lendo e escrevendo em arquivos}
  ...
  % \lstinputlisting[style=tinyc,caption=phonebook.c]{phonebook.c}
  ...
  \lstinputlisting[style=tinyc,caption=jpeg.c,autogobble]{jpeg.c}
  ...
  \begin{lstlisting}[style=tinyc,autogobble,caption=filter]
    #include "helpers.h"
