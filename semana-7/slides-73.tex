...
\begin{frame}[allowframebreaks,fragile]{copia de string}
  ...
  \lstinputlisting[style=normalc,caption=copy0.c]{copy0.c}

  \framebreak

  \lstinputlisting[style=normalc,caption=copy1.c]{copy1.c}

  \framebreak

  \lstinputlisting[style=normalc,caption=copy2.c]{copy2.c}
