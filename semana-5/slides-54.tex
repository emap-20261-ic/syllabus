...
\begin{frame}[fragile,allowframebreaks]{Busca linear}
  ...
  \lstinputlisting[style=normalc,caption=numbers1.c]{numbers1.c}

  \framebreak

  \begin{lstlisting}[style=normalc,caption=names0.c]
    int main() {
      string names[] =
        {"Bill", "Charlie", "Fred",
  ...
  \begin{lstlisting}[style=normalc,caption=names1.c]
    int main() {
      string names[] =
        {"Bill", "Charlie", "Fred",
         "George", "Ginny", "Percy", "Ron"};
...
\begin{frame}[fragile,allowframebreaks]{Busca Binária Interativa em C}
  ...
  \begin{lstlisting}[style=tinyc,caption=numbers2.c]
