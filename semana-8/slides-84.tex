...
\begin{frame}[fragile]{O arquivo list.h}
  ...
  \begin{lstlisting}[style=normalc,caption=list/list.h]
...
\begin{frame}[fragile]{O arquivo list.c}
  ...
  \begin{lstlisting}[style=normalc,caption=list/list.c]
    #include <stdio.h>
    #include <stdlib.h>
    #include "list.h"
...
\begin{frame}[fragile,allowframebreaks]{O arquivo test.c}
  ...
  \begin{lstlisting}[style=normalc, caption=list/list-test.c]
    #include <stdio.h>
    #include <stdlib.h>
    #include "list.h"
...
\begin{frame}[fragile,allowframebreaks]{a compilação}
  ...
  \begin{lstlisting}[style=code,language=make,caption=Makefile]
    OPT=-g -Wall ...
...
\begin{frame}{Exemplos extras}
  ...
  \begin{itemize}
    \item \texttt{arrays-0.c}, \texttt{arrays-1.c}, \texttt{arrays-2.c},
          \texttt{arrays-3.c}, \texttt{arrays-4.c}
    \item \texttt{matriz.c}
    \item \texttt{pointers-of-functions.c}, \texttt{pointers-of-pointers.c}
    \item \texttt{list/list-glib.c} (variante com GLib)
    \item \texttt{test.txt} (entrada de exemplo)
  \end{itemize}
\end{frame}
