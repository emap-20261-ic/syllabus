...
\begin{frame}[fragile,allowframebreaks]{Depuração (debug)}
  ...
  \lstinputlisting[style=normalc,caption=buggy0.c]{buggy0.c}

  \framebreak

  Qual o bug? No VS Code, usar `step into'.

  \lstinputlisting[style=tinyc,caption=buggy1.c]{buggy1.c}

  \framebreak

  Lembrando do problema em \ilcode{src/mario2.c}. Vamos
